...
- **Lealith:** Gato espiritual de outra dimensao. Quando Zion estilhacou, um estilhaco atravessou o veu entre mundos e atingiu um felino ancestral, fundindo-o com forma humanoide. Agil, misterioso, com olhos que enxergam entre as fendas. Seu sino dourado ressoava em harmonia com o Coracao de Zion — agora ecoa fragmentado, guiando-o pelas fraturas
...
| Arma | Descricao |
|---|---|
| **Espada Samurai** | Ataques rapidos, chance de critical hit, combo system |
| **Espada Cloud (FF7)** | Ataque lento mas dano massivo em area frontal |
| **Foice** | Gira ao redor do personagem, drena vida dos inimigos |
| **Machado Viking** | Arremesso + retorno tipo boomerang |
| **Chicote** | Longo alcance, atravessa inimigos (estilo Belmont/Castlevania) |
| **Luvas de Boxe** | Soco rapido, knockback forte, combo de 3 hits |
| **Katana Dupla** | Dois cortes simultaneos em X, velocidade alta |
| **Martelo de Guerra** | Smash no chao com onda de impacto |
| **Lanca** | Thrust em linha reta, penetra multiplos inimigos |
| **Nunchaku** | Ataque em cone giratorio, velocidade aumenta com level |

### Ranged

| Arma | Descricao |
|---|---|
| **Bazuca** | Explosao em area, cooldown longo |
| **Metralhadora** | Spray de projeteis, dano baixo mas volume insano |
| **Staff** | Projeteis magicos homing (perseguem inimigos) |
| **Arco Elfico** | Flechas que atravessam e ricocheteiam nas paredes |
| **Shuriken** | Dispara em 4 direcoes, gira e volta |
| **Pistola Dupla** | Disparo rapido alternado, estilo John Wick |
| **Lanca-chamas** | Dano continuo em cone, inimigos ficam queimando |
| **Cajado de Gelo** | Projetil que congela inimigos em area |
| **Besta (Crossbow)** | Tiro unico de dano alto, perfura em linha |
| **Canhao de Plasma** | Carrega e solta um beam devastador |

### Summoner / Special

| Arma | Descricao |
|---|---|
| **Necromante** | Invoca esqueletos dos inimigos mortos pra lutar por voce |
| **Drone** | Orbita o jogador e atira automaticamente no mais proximo |
| **Totem** | Planta totens no chao que atacam inimigos na area |
| **Bomba Relogio** | Dropa bombas que explodem apos timer |
| **Livro Magico** | Orbita ao redor e dispara paginas cortantes |
| **Garrafa de Veneno** | Cria pocas de dano no chao |
| **Corrente Eletrica** | Raio que pula entre inimigos proximos (chain lightning) |
| **Portal** | Abre portais que teleportam inimigos pra longe ou pra cima de outros |
