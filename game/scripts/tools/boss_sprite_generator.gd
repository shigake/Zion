...
func _generate_necromancer() -> void:
	...
	var robe = Color(0.38, 0.16, 0.52)
	var robe_dark = Color(0.25, 0.10, 0.35)
	var robe_light = Color(0.52, 0.28, 0.65)
	...
	var staff = Color(0.45, 0.32, 0.22)
	var staff_dark = Color(0.30, 0.20, 0.14)
	var aura = Color(0.3, 0.9, 0.3, 0.4)
	var aura_bright = Color(0.4, 1.0, 0.5, 0.55)
	var outline = Color(0.18, 0.06, 0.25)
